...
client = MongoClient("mongodb+srv://Beny132001:Beny132001@echat.enirpp4.mongodb.net/?retryWrites=true&w=majority")

chat_db = client.get_database("Echatdb")
...
def save_user(username,email,password):
    users_collection.insert_one({'_id' : username, 'email' : email, 'password' : password}) # In meanwhile i Dont using password hash(FOR SECURITY) 
